...
const Items = forwardRef<HTMLDivElement, MenuItemsProps<"div">>(
  (props, ref) => {
                      ...
                      <TransitionChild as={Fragment}>
                        <MenuItems
                          ...
                          className={cn(
                            ...
                            "bg-surface-bright z-50 flex flex-col overflow-hidden max-lg:max-h-full",
                        ...
                        >
                          {(bag) => (
                            <>
                              <div
                                className={cn(
                                  "relative shrink-0 transition max-lg:h-6",
                                  {
