...
export type BadgeProps<TTag extends ElementType = typeof DEFAULT_BADGE_TAG> =
  Props<
    TTag,
    object,
    never,
...
function BadgeFn<TTag extends ElementType = typeof DEFAULT_BADGE_TAG>(
  ...
  const { className, variant, color, size, anchor, ...theirProps } =
    props as BadgeProps<typeof DEFAULT_BADGE_TAG>;
