    ...
    create: {
      ...
      profile: {
        create: {
          ...
          familyInfo: {
            create: {
              fatherEducation: EducationLevel.NoEducation,
              motherEducation: EducationLevel.Diploma,
              fatherEthnicity: Ethnicity.Persian,
              motherEthnicity: Ethnicity.Persian,
              siblingPosition: 1,
              brothersCount: 3,
              sistersCount: 1,
              hasMarriedSiblings: false,
            },
          },
          marriagePreferences: {
            create: {
              ...
              educationLevels: [EducationLevel.NoEducation],
              heightMin: 157,
              heightMax: 167,
              skinColors: [SkinColor.Black, SkinColor.Olive, SkinColor.Wheatish, SkinColor.White],
              healthStatuses: [HealthStatus.Healthy],
              incomeMin: 0,
              incomeMax: 30_000_000,
              housingStatuses: [HousingStatus.NoHouse, HousingStatus.OwnHouse],
              carStatuses: [CarStatus.NoCar, CarStatus.HasCar],
              preferredPersonalityTypes: [],
              additionalNote: "به دنبال یک زوج ایده‌آل برای یک زندگی شاد و عاشقانه است.",
            },
          },
        },
      },
        ...
        create: {
          ...
          marriagePreferences: {
            create: {
              ...
              carStatuses: [CarStatus.NoCar, CarStatus.HasCar],
              preferredPersonalityTypes: [],
              additionalNote: "دارای تخصص در برنامه‌نویسی وب و فارغ‌التحصیل رشته کامپیوتر.",
            },
          },
        },
      },
        ...
        create: {
          ...
          marriagePreferences: {
            create: {
              ...
              carStatuses: [CarStatus.NoCar, CarStatus.HasCar],
              preferredPersonalityTypes: [],
              additionalNote: "خانواده‌ای با تحصیلات پایه و ارتباطات خانوادگی خوب.",
            },
          },
        },
      },
        ...
        create: {
          ...
          marriagePreferences: {
            create: {
              ...
              carStatuses: [CarStatus.NoCar, CarStatus.HasCar],
              preferredPersonalityTypes: [],
              additionalNote: "ترجیح به ازدواج با فردی با شرایط مشابه با سن نزدیک.",
            },
          },
        },
      },
        ...
        create: {
          ...
          marriagePreferences: {
            create: {
              ...
              carStatuses: [CarStatus.NoCar, CarStatus.HasCar],
              preferredPersonalityTypes: [],
              additionalNote: "ویژگی‌های فیزیکی متناسب و زیبایی بالا.",
            },
          },
        },
      },
